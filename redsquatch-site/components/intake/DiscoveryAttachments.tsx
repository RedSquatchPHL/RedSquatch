...
export default function DiscoveryAttachments({ discoveryFormId }: Props) {
  ...
  const loadFiles = useCallback(async () => {
    try {
      const res = await fetch(`${API}/api/client/files/discovery/${discoveryFormId}`, { credentials: 'include' });
  ...
  const uploadFile = async (file: File) => {
    ...
    try {
      ...
      const res = await fetch(`${API}/api/client/files/discovery/${discoveryFormId}`, {
        method: 'POST',
        credentials: 'include',
        body,
      });
